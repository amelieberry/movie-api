...
let allowedOrigins = ['http://localhost:8080', 'http://testsite.com', 'http://localhost:1234', 'http://localhost:4200', 'https://trackm-client.netlify.app', 'https://main--trackm-client.netlify.app', 'https://amelieberry.github.io'];
app.use(cors({
